...
# improt random list
import random
# import the operation system from computer
import os

# set up the attribute of the window
SCREEN_WIDTH = 800
SCREEN_HEIGHT = 600
SCREEN_TITLE = "Move with a Sprite Animation Example"

# define the attribute of the coin
COIN_SCALE = 0.5
COIN_COUNT = 50

# set up the character's moving speed
MOVEMENT_SPEED = 5
...
class MyGame(arcade.Window):
    ...
    # initialized the attribute of the window
    ...
    def setup(self):
        ...
        # set up the player can move to the left or right
        ...
        # set up the sprites when the character is moving towards left
        ...
        self.player.walk_right_textures.append(arcade.load_texture("images/character_sprites/characterw3.png",
                                                                   scale=character_scale))
        # set up the sprites when the character is oving towards right
        ...
        self.player.walk_left_textures.append(arcade.load_texture("images/character_sprites/characterw3.png",
                                                                  scale=character_scale, mirrored=True))
        # set up the distance the player can move
        self.player.texture_change_distance = 20

        # set up the radius of the player
        ...
        # a founction of the coins in the game
        for _ in range(COIN_COUNT):
            coin = arcade.AnimatedTimeSprite(scale=0.5)
            coin.center_x = random.randrange(SCREEN_WIDTH)
            coin.center_y = random.randrange(SCREEN_HEIGHT)

            # set up the coins location
            coin.textures = []
    ...
    # define a function called on_draw
    def on_draw(self):
        """
        Render the screen.
        """
    ...
    # define the moving speed function
    ...
    # define a function that can let the keyboard to control the character to move left and right
    ...
    # to continue update the movment
...
# set up the window on the screen
def main():
    """ Main method """
